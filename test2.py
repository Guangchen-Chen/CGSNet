...
def main(args):
    ...
    best_model_path = r'/home/bj/projects/Semi-supervised/ST-PlusPlus-master/exprements/sodl/id=13/deeplabv3plus_resnet50_66.64.pth'
    # best_model = torch.nn.DataParallel(model)
    best_model = model
...
if __name__ == '__main__':
    ...
    if args.epochs is None:
        args.epochs = {'pascal': 80, 'cityscapes': 240, 'sodl':80}[args.dataset]
    if args.lr is None:
        args.lr = {'pascal': 0.001, 'cityscapes': 0.004, 'sodl':0.01}[args.dataset] / 16 * args.batch_size
