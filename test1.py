...
def main(args, config):
    ...
    #手动模型载入
    best_name = '/home/bj/projects/Semi-supervised/ST-PlusPlus-master/exprements/sodl/id=1/deeplabv3plus_resnet50_77.47.pth'
    ...
    label(best_model, valloader, args, istest=True)
...
def label(model, dataloader, args, istest):
    ...
    with torch.no_grad():
        ...
        for img, mask, id in tbar:
            ...
            Res = metric.evaluate()[4]
            Pos = metric.evaluate()[5]
            F1score = metric.evaluate()[6]
            mF1score = metric.evaluate()[7]
