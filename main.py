...
def main(args):
    ...
    best_model, checkpoints = train(model, trainloader, valloader, criterion, optimizer, args, 'stage1')
    #
    # """
    ...
    #     model, optimizer = init_basic_elems(args)
    #
    #     train(model, trainloader, valloader, criterion, optimizer, args, 'stage3_3')
    #
    #     return
    ...
    # model, optimizer = init_basic_elems(args)
    #
    # best_model = train(model, trainloader, valloader, criterion, optimizer, args, 'stage4_6')
    #
    ...
    # model, optimizer = init_basic_elems(args)
    #
    # train(model, trainloader, valloader, criterion, optimizer, args, 'stage6_6')
...
if __name__ == '__main__':
    ...
    if args.epochs is None:
        args.epochs = {'pascal': 80, 'cityscapes': 240, 'sodl':80, 'ir':80, 'whdld':80}[args.dataset]
    if args.lr is None:
        args.lr = {'pascal': 0.001, 'cityscapes': 0.004, 'sodl':0.01, 'ir':0.01, 'whdld':0.01}[args.dataset] / 16 * args.batch_size
