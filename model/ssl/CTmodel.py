...
from model.ssl.decoders import *
from model.ssl.encoder import *
from Tools.utils.losses import CE_loss
...
class CCT(BaseModel):
    def __init__(self, num_classes, conf, sup_loss=None, cons_w_unsup=None, ignore_index=None, testing=False,
        ...
        # Create the model
        self.encoder = Deeplabv3plusEncoder(backbone = 'resnet50', nclass=num_classes)
        # self.encoder = DeepLabV2Encoder(backbone='resnet50', nclass=num_classes)
        # self.encoder = PSPNetEncoder(backbone='resnet50', nclass=num_classes)

        # The main encoder
        upscale = 4    # deeplabv3+ = 4   deeplabv2 = 8  pspnet=8
        decoder_in_ch = 256 #  # deeplabv3+ = 256   deeplabv2 = 6  pspnet=512
    ...
    def forward(self, x_l=None, target_l=None, x_ul=None, target_ul=None, curr_iter=None, epoch=None):
        ...
        # If semi supervised mode
            ...
            loss_unsup = loss_unsup * weight_u * 0.1
  ...
  # return chain(self.encoder.get_module_params(), self.encoder.get_up_params(), self.main_decoder.parameters(),
  #                       self.aux_decoders.parameters())
  #
  #       return chain(self.encoder.get_module_params(), self.encoder.get_up_params(), self.main_decoder.parameters())
